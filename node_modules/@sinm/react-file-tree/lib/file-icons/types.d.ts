export declare type IconColor = [string | null, string | null];
export declare type IconBase = [
...
export declare type IconDbItem = [IconBase[], number[][], Record<string, number>];
export declare type IconDb = IconDbItem[];
