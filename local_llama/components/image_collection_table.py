import reflex as rx
from ..states.image_collection_table_state import ImageCollectionTableState


def image_collection_table() -> rx.Component:
    """Modern table displaying image collection records."""
    return rx.vstack(
        # Modern divider
        rx.box(
            height="1px",
        ...
        rx.hstack(
            ...
            rx.button(
                ...
                on_click=ImageCollectionTableState.load_collections,
                size="2",
                variant="ghost",
                style={
        ...
        rx.box(
            rx.cond(
                ImageCollectionTableState.is_loading,
                # Loading state
                rx.center(
                    rx.hstack(
                        rx.icon(
                ...
                rx.scroll_area(
                    rx.table.root(
                            ...
                            rx.table.row(
                                ...
                                rx.table.column_header_cell(
                                    rx.hstack(
                                        ...
                                        rx.icon(
                                            tag=rx.cond(
                                                ImageCollectionTableState.sort_column == "date",
                                                rx.cond(
                                                    ImageCollectionTableState.sort_direction == "asc",
                                                    "chevron-up",
                                                    "chevron-down"
                                                ),
                                                "chevrons-up-down"
                                    ...
                                    on_click=lambda: ImageCollectionTableState.sort_by_column("date"),
                                    style={
                                ...
                                rx.table.column_header_cell(
                                    rx.hstack(
                                        ...
                                        rx.icon(
                                            tag=rx.cond(
                                                ImageCollectionTableState.sort_column == "employee",
                                                rx.cond(
                                                    ImageCollectionTableState.sort_direction == "asc",
                                                    "chevron-up",
                                                    "chevron-down"
                                    ...
                                    on_click=lambda: ImageCollectionTableState.sort_by_column("employee"),
                                    style={
                                        "_hover": {"background": "rgba(255, 255, 255, 0.08)"},
                                        "user_select": "none",
                                    }
                                ...
                                rx.table.column_header_cell(
                                    rx.hstack(
                                        ...
                                        rx.icon(
                                            tag=rx.cond(
                                                ImageCollectionTableState.sort_column == "asset",
                                                rx.cond(
                                                    ImageCollectionTableState.sort_direction == "asc",
                                                    "chevron-up",
                                                    "chevron-down"
                                    ...
                                    on_click=lambda: ImageCollectionTableState.sort_by_column("asset"),
                                    style={
                                        "_hover": {"background": "rgba(255, 255, 255, 0.08)"},
                                        "user_select": "none",
                                    }
                                ...
                                rx.table.column_header_cell(
                                    rx.hstack(
                                        ...
                                        rx.icon(
                                            tag=rx.cond(
                                                ImageCollectionTableState.sort_column == "project",
                                                rx.cond(
                                                    ImageCollectionTableState.sort_direction == "asc",
                                                    "chevron-up",
                                                    "chevron-down"
                                    ...
                                    on_click=lambda: ImageCollectionTableState.sort_by_column("project"),
                                    style={
                                        "_hover": {"background": "rgba(255, 255, 255, 0.08)"},
                                        "user_select": "none",
                                    }
                                ),
                                # Sortable Imaging Method column
                                rx.table.column_header_cell(
                                    rx.hstack(
                                        rx.text("Method"),
                                        rx.icon(
                                            tag=rx.cond(
                                                ImageCollectionTableState.sort_column == "method",
                                                rx.cond(
                                                    ImageCollectionTableState.sort_direction == "asc",
                                                    "chevron-up",
                                                    "chevron-down"
                                    ...
                                    on_click=lambda: ImageCollectionTableState.sort_by_column("method"),
                                    style={
                                        "_hover": {"background": "rgba(255, 255, 255, 0.08)"},
                                        "user_select": "none",
                                    }
                                ),
                                # Sortable Size column
                                rx.table.column_header_cell(
                                    rx.hstack(
                                        rx.text("Size"),
                                        rx.icon(
                                            tag=rx.cond(
                                                ImageCollectionTableState.sort_column == "size",
                                                rx.cond(
                                                    ImageCollectionTableState.sort_direction == "asc",
                                                    "chevron-up",
                                                    "chevron-down"
                                    ...
                                    on_click=lambda: ImageCollectionTableState.sort_by_column("size"),
                                    style={
                                        "_hover": {"background": "rgba(255, 255, 255, 0.08)"},
                                        "user_select": "none",
                                    }
                                ...
                                rx.table.column_header_cell(
                                    rx.hstack(
                                        ...
                                        rx.icon(
                                            tag=rx.cond(
                                                ImageCollectionTableState.sort_column == "result",
                                                rx.cond(
                                                    ImageCollectionTableState.sort_direction == "asc",
                                                    "chevron-up",
                                                    "chevron-down"
                                    ...
                                    on_click=lambda: ImageCollectionTableState.sort_by_column("result"),
                                    style={
                                        "_hover": {"background": "rgba(255, 255, 255, 0.08)"},
                                        "user_select": "none",
                                    }
                        ...
                        rx.table.body(
                            rx.foreach(
                                ImageCollectionTableState.collections,
                                lambda collection: rx.table.row(
                                    # Status indicator cell (recent entries and duplicates)
                                    rx.table.cell(
                                        rx.hstack(
                                        ...
                                        rx.box(
                                            ...
                                            background=rx.cond(
                                                ...
                                                rx.cond(
                                                    ...
                                                    "rgba(239, 68, 68, 0.2)",
                                                    rx.cond(
                                                        collection["result"] == "Partial Success",
                                                        "rgba(251, 146, 60, 0.2)",
                                                        rx.cond(
                                                            collection["result"] == "In Progress",
                                                            "rgba(59, 130, 246, 0.2)",
        ...
        rx.hstack(
            ...
            rx.text(
                ImageCollectionTableState.records_display_text,
                font_size="0.875rem",
                color="rgba(255, 255, 255, 0.7)",
            ),
            ...
            rx.hstack(
                ...
                rx.button(
                    ...
                    on_click=ImageCollectionTableState.first_page,
                    disabled=ImageCollectionTableState.current_page == 1,
                    size="2",
                    variant="ghost",
                    style={
                        "color": "rgba(255, 255, 255, 0.7)",
                ...
                rx.button(
                    ...
                    on_click=ImageCollectionTableState.previous_page,
                    disabled=ImageCollectionTableState.current_page == 1,
                    size="2",
                    variant="ghost",
                    style={
                ...
                # Page info
                rx.text(
                    f"Page {ImageCollectionTableState.current_page} of {ImageCollectionTableState.total_pages}",
                    font_size="0.875rem",
                    color="rgba(255, 255, 255, 0.9)",
                    margin="0 1rem",
                ),
                ...
                rx.button(
                    ...
                    on_click=ImageCollectionTableState.next_page,
                    disabled=ImageCollectionTableState.current_page == ImageCollectionTableState.total_pages,
                    size="2",
                    variant="ghost",
                    style={
                        "color": "rgba(255, 255, 255, 0.7)",
                ...
                rx.button(
                    ...
                    on_click=ImageCollectionTableState.last_page,
                    disabled=ImageCollectionTableState.current_page == ImageCollectionTableState.total_pages,
                    size="2",
                    variant="ghost",
                    style={
        ...
        max_width="1400px",
        margin="0 auto",
        on_mount=ImageCollectionTableState.load_collections,
    )