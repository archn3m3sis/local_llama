...
from ..components.log_collection_form import log_collection_form
from ..components.log_collection_table import log_collection_table
...
def Logs() -> rx.Component:
    return rx.vstack(
        ...
        metallic_title("IAMS - Log Collection"),

        # Content area with tab system
        rx.vstack(
            rx.text(
                "Record log collections from industrial standalone systems & review log records", 
                color="gray.400", 
                font_size="1.1rem",
                margin_bottom="2em",
                style={
            ...
            rx.hstack(
                ...
                rx.hstack(
                    rx.button(
                        ...
                        on_click=LogCollectionState.reset_form,
                        size="3",
                        style={
                    ...
                    rx.button(
                        rx.hstack(
                            rx.cond(
                                LogCollectionState.is_submitting,
                        ...
                        on_click=LogCollectionState.submit_log_collection,
                        size="3",
                        disabled=rx.cond(
                            LogCollectionState.form_is_valid & ~LogCollectionState.is_submitting,
                            False,
                            True
                        ),
                        style={
                            "background": rx.cond(
                                LogCollectionState.form_is_valid,
